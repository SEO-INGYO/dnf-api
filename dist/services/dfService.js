...
exports.getDfList = exports.getDfCharacterEquipment = exports.getDfServerId = exports.getDfCharacter = void 0;
const DfApis = __importStar(require("../apis/dfApi"));
/**
 * 데이터 가공
...
const getDfCharacter = (serverName, characterName) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const response = yield DfApis.getDfCharacterSearch(serverId, characterName);
...
const getDfServerId = (serverName) => __awaiter(void 0, void 0, void 0, function* () {
    let serverId = null;
    try {
        const response = yield DfApis.getDfServers();
...
const getDfCharacterEquipment = (serverId, characterId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield DfApis.getDfCharacterEquipment(serverId, characterId);
        return response;
    }
    catch (error) {
        console.error('Error fetching servers:', error);
...
const getDfList = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const responseServer = yield DfApis.getDfServers(); // 1. getDfServers()로 서버 ID 리스트 파싱 및 가져오기
        ...
        for (const server of servers) {
            try {
                ...
                const minFame = 30000;
                const maxFame = 34000;
                const responseCharacter = yield DfApis.getDfCharacterFameSearch(serverId, minFame, maxFame);
                const characters = responseCharacter.rows;
                for (const character of characters) {
                    const serverId = character.serverId;
                    const characterId = character.characterId;
                    const responseEquipment = yield DfApis.getDfCharacterEquipment(serverId, characterId);
                    const equipments = responseEquipment;
